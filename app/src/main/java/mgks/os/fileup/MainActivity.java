...
public class MainActivity extends AppCompatActivity{
    ...
    private static String webview_url   = "http://139.59.57.119:3000/d/LmTA89zmk/sih-building-management-monitoring-and-control-unit?orgId=1&refresh=5s&kiosk";    // web address or local file location you want to open in webview
